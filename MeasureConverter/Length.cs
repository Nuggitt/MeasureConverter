...
public class Length
{
    ...
    public Length(double measure, MeasurementSystem system)
    {
    ...
    public double Convert()
    {
        ...
        {
            return Math.Round(_measure / 2.54, 2); // Metric -> Imperial
        }
        else
        {
            return Math.Round(_measure * 2.54, 2); // Imperial -> Metric
        }
    }
}